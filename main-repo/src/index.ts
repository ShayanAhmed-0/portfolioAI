...
import { init, run, run_socket } from "./server";
import admin, { ServiceAccount } from "firebase-admin";
import serviceAccount from "../streeteats-4c4a7-firebase-adminsdk-ll9ph-17c5bac6ea.json";
// C:\Users\shayan.ahmed\Desktop\backend\street_eats\main-repo\
(async () => {
  try {
