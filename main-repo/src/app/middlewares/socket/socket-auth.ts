...
//   const verification: any = verifyJWT(authHeader, validatedEnv.EMPLOYEE_SECRET);
...
//   const vendor = await VendorService.getVendorStatus(verification.profileId);
//   if (vendor && vendor.isActive) {
//     return { message: "vendor is active", status: 401 };
//   }
